...
from tests.fixtures.mocks import MockRequestsResponse
...
class TestBet365(TestCase):
    ...
    def test_get_raises(self, mock_api_response):
        ...
        mock_api_response.return_value = MockRequestsResponse(filepath=None, status=404)

        with pytest.raises(HTTPError):
            self.test_client._get(url_extras="failure", params={"oops": "sorry"})
    ...
    def test_upcoming_events(self, mock_api_response):
        ...
        result = self.test_client._get(url_extras="upcoming", params={"params": "dict"})
